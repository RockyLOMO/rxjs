...
$.getDateDiff = function (orgDate, format) {
    var sDate = $.format.date(orgDate, "yyyy-MM-dd HH:mm");
    dateTime = Date.parse(sDate.replace(/-/gi, "/"));
    var publishTime = dateTime / 1000,
        d_seconds,
        d_minutes,
        d_hours,
        d_days,
    ...
    if (d_days > 0 && d_days < 3) {
        ...
        //return format ? $.format.date(orgDate, format) : sDate;
        return Y + '-' + M + '-' + D + '&nbsp;' + H + ':' + m;
    }
};